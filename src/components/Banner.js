...
export const Banner = () => {
    ...
    const toRotate = ["Web Developer", "Student", "Full-Stack Dev", "Licenced Drone Pilot", "Digital Creator"];
                ...
                <Row className="align-items-center">
                    <Col xs={12} md={6} xl={7}>
                        ...
                        <h1>{'hi im Max Hoogeweg'}
                            <br />
                            <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Student", "Full-Stack Dev", "licenced drone pilot", "Digital Creator" ]'><span className="wrap">{text}</span></span></h1>
